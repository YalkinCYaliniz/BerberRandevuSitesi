...
namespace BerberRandevuSitesi.Controllers
{
    ...
    public class CalisanlarController : Controller
    {
        ...
        // Belirlediğimiz çalışanı listelemeye yarayan method
        [HttpGet("{id}")]
        ...
        // Çalışan düzenleme işleminı gerçekleştiren method
        [HttpPut("{id}")]
        ...
        // Yetenek ekleme ve silme işlemleri
